...
export class ChannelsController {
  ...
  //:workspace 내부의 :name의 안 읽은 채팅 유무를 가져옴
  @Get(':name/unreads')
  ...
  //:workspace 내부의 :name 멤버 목록을 가져옴
  @Get(':name/members')
  getAllMembers(@Param() param) {
    console.log(param.url, param.name);
  }

  //:workspace 내부의 :name로 멤버 초대
  @Post(':name/members')
